...
import styles from "./SelectEsgAddress.module.css";
...
function SelectEsgAddress() {
    ...
    // Retrieve selected subscription package from state
        ...
        <div className={styles['page']}>
            ...
            <div className={styles['content']}>
                ...
                <div className={styles['section-header']}>
                    ...
                    <p className={styles['section-subtitle']}>Where should we pick up your recyclable items?</p>
                </div>
                ...
                <div className={styles['address-list']}>
                    ...
                    <div className={styles['add-new-button']} onClick={() => navigate("/new-address", { state: { from: '/esg/select-address' } })}>
...
export default SelectEsgAddress;
